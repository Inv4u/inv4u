...
export const features: FeatureDetail[] = [
  {
    ...
    intro:
      'ההזמנה היא הרושם הראשון של האירוע שלכם. עם Maorly היא הופכת לחוויה דיגיטלית מרהיבה — עיצוב מותאם אישית, וידאו, ניווט וקריאה לפעולה ברורה, הכל בלחיצה אחת מהנייד.',
    highlights: [
      {
        icon: '🎨',
  ...
  },
  {
    ...
    intro:
      'הלב של Maorly. במקום שעות של שיחות טלפון, המערכת שולחת אישורי הגעה בוואטסאפ, מתזכרת אוטומטית, ואפילו מתקשרת בקול טבעי בעברית למי שלא ענה — ומעדכנת הכל בדשבורד אחד.',
    highlights: [
      {
        icon: '💬',
        title: 'וואטסאפ ו-SMS',
  ...
  },
  {
    ...
    intro:
      'ביום האירוע הכל קורה מהר. Maorly נותן לכם שליטה מלאה: כניסה עם QR, ספירת אורחים חיה, והשוואה בין מי שאישר למי שהגיע בפועל — כדי שתדעו בדיוק מה קורה באולם.',
    highlights: [
      {
        icon: '🎫',
        title: 'כניסה עם QR',
